  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled ? 'bg-white shadow-sm py-4' : 'bg-transparent py-5'
      }`}
    >
      <div className="container mx-auto flex items-center justify-between">
        <Link to="/" className="font-bold text-2xl text-rebels-blue -my-2">
          <img 
            src="/logo-text-transparent.png" 
            alt="99rebels" 
            className="h-16 max-h-16 w-auto py-2"
            style={{ height: '64px' }}
          />
        </Link>
        ...
        <nav className="hidden md:flex items-center gap-6">
          ...
          <Link to="/services" className="text-gray-700 hover:text-rebels-blue transition-colors">
            Services
          </Link>
          <Link to="/about" className="text-gray-700 hover:text-rebels-blue transition-colors">
            About
          </Link>
