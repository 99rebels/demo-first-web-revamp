        ...
        <section className="section">
          <div className="container mx-auto">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-6 animate-fade-in-up" style={{animationDelay: "0.2s"}}>
                <Card className="border-0 shadow-lg">
                  <CardContent className="p-6 flex flex-col items-center text-center">
                    <div className="w-16 h-16 rounded-full bg-rebels-blue flex items-center justify-center mb-4 mt-6">
              ...
              <Card className="border-0 shadow-lg mt-12 animate-fade-in-up" style={{animationDelay: "0.4s"}}>
